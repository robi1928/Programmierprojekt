...
<body>
  ...
  <!-- Dropdown zur Auswahl des Benutzers -->
    <form class="form" method="get" action="dd_nutzer_aktualisieren_projektleitung.php">
        <div class="field">
  ...
  <div class="card card-narrow">
    <form action="dd_nutzer_aktualisieren_projektleitung.php" method="post" class="form">
