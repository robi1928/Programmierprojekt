...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($typ === 'stundenzettel') {
            CStundenzettelRepository::freigabeDurchTeamleitung(
                $pdo,
                $id,
                $aktuellerBenutzerId,
                $entscheidung
            ...
            CUrlaubsantragRepository::freigabeDurchTeamleitung(
                $pdo,
                $id,
                $aktuellerBenutzerId,
                $entscheidung,
...
// Abgelehnte Urlaubsanträge für diese Teamleitung (eigene Anträge der TL)
$sqlUrlaubAbgelehnt = "
    SELECT
        a.antrag_id,
        a.start_datum,
