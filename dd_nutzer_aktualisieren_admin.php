...
<body>
  ...
  <form method="get" action="dd_nutzer_aktualisieren_admin.php">
  ...
  <?php if ($Benutzer): ?>
  <form action="dd_nutzer_aktualisiert_admin.php" method="post">
      ...
      <tr><td>Rolle:</td>
        <td>
          <select name="rolle" required>
            ...
            <option value="3" <?= $Benutzer->GetRolle()==3?'selected':''; ?>>Admin</option>
          </select>
        </td>
      </tr>
